...
/**
 * Simplified test management system client returning a hard coded scenario.
 * <p>
 * In a real project this class would fetch test cases from an external system.
 */
@Component
public class StubTmsClient {
    ...
    /**
     * Returns the test case description for the provided identifier.
     */
