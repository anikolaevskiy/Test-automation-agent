...
public class AgentTest {
    ...
    public void test() {
        ...
        var result = agent.executeTestScenario("""
                ...
                Expected result - After clicking \"Code\", the clone popup/dropdown opens showing cloning options (HTTPS, SSH, Git
Hub CLI) and a copyable repository URL (options like \"Open with GitHub Desktop\" and \"Download ZIP\" are visible).
                """);
